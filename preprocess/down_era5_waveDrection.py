...
years = [str(x) for x in range(2004,2025)]
for year in years:
    ...
    temp_file_name = f'/media/data5/wyp/lq/SWH_Retrieval/data_era5_80year/era5_wave_drection_origin/ERA5_wave_direction_{year}_60N-0_100-160E.nc'
