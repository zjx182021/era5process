import sys
sys.path.append('/media/data3/wyp/InitalField')
import os
import numpy as np
import h5py
import datetime
...
def get_norm_h8_data(h8_ori_path, time_range, saved_path):
    ...
    norm_info = read_norm_info(info_type='h8')
...
if __name__ == '__main__':
    ...
    # time_range = config['inversion_stage2_random']['time_range']
    # input_path = config['inversion_stage2_random']['input_path']
    ...
    target_path = config['inversion_stage2_random']['target_path']
